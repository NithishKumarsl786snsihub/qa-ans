...
export const questions: Question[] = [
  {
    ...
    answerItems: [{"label": "Deployment type", "value": "Standard", "options": ["Standard", "Global Standard", "Provisioned", "Global Provisioned"]}, {"label": "Version update policy", "value": "Once the current version expires", "options": ["Once the current version expires", "Opt out of automatic model version upgrades", "Upgrade once a new default version becomes available"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "The LangChain service will appear in Traces without configuring a tracer.", "value": "No", "options": ["Yes", "No"]}, {"label": "Setting different OTEL_SERVICE_NAME values separates the services in Application Insights.", "value": "Yes", "options": ["Yes", "No"]}, {"label": "When using enable_content_recording=False, prompts and tool data will be captured in the telemetry.", "value": "No", "options": ["Yes", "No"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Pipeline1", "value": "Single-file task in standard mode", "options": ["Single-file task in standard mode", "Single-file task in pro mode", "Multi-file task in standard mode", "Multi-file task in pro mode"]}, {"label": "Pipeline2", "value": "Multi-file task in pro mode", "options": ["Single-file task in standard mode", "Single-file task in pro mode", "Multi-file task in standard mode", "Multi-file task in pro mode"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "First Dropdown (credential =)", "value": "DefaultAzureCredential", "options": ["DefaultAzureCredential", "AzureKeyVaultCredential", "ManagedIdentityCredential", "ClientSecretCredential"]}, {"label": "Second Dropdown (response = openai_client.responses.)", "value": "create", "options": ["create", "compact", "retrieve", "execute"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "If/else condition expression", "value": "Not(IsBlank(Local.Var01))", "options": ["Not(IsBlank(Local.Var01))", "IsBlank(Local.Var01)", "IsEmpty(Local.Var01)", "Not(IsEmpty(Local.Var01))"]}, {"label": "Send message expression", "value": "Upper(Local.Var01)", "options": ["Upper(Local.Var01)", "Text.Upper(Local.Var01)", "String.ToUpper(Local.Var01)", "Capitalize(Local.Var01)"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Guardrails configuration", "value": "Select User input, Output, Tool response, and Tool call; set Action to Block", "options": ["Select User input, Output, Tool response, and Tool call; set Action to Block", "Select User input and Output; set Action to Allow", "Select Tool response only; set Action to Audit", "Select User input only; set Action to Mask"]}, {"label": "Storage access configuration", "value": "System-assigned managed identity assigned Storage Blob Data Reader", "options": ["System-assigned managed identity assigned Storage Blob Data Reader", "Account API Key with full access", "User-assigned identity with Owner role", "Anonymous public read access"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Approval step type", "value": "ask_question", "options": ["ask_question", "basic_chat", "data_transformation"]}, {"label": "Refund condition", "value": "approval == \"approved\"", "options": ["approval == \"approved\"", "propose_refund.output != null", "true"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Option A (Visual Block)", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Speech recognition requests will fall back to the most recent base model for the", whyIncorrect: "" },
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Unsupported responses", "value": "Groundedness evaluation metrics", "options": ["Groundedness evaluation metrics", "Risk and safety metrics", "Latency breakdown traces", "Indexer status history"]}, {"label": "Policy violations", "value": "Risk and safety metrics", "options": ["Groundedness evaluation metrics", "Risk and safety metrics", "Latency breakdown traces", "Indexer status history"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "a header parameter defined for each operation", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
    answerItems: [{"label": "Correct option", "value": "C"}],
    correctOptionIds: ["C"],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Metrics to enable", "value": "Model Availability Rate and Provisioned Utilization", "options": ["Model Availability Rate and Provisioned Utilization", "HTTP Status Codes and Error Rate", "Latency Breakdown and Token Count", "Request Volume and Active Connections"]}, {"label": "Diagnostic log to collect", "value": "Request Response", "options": ["Request Response", "Audit Logs", "Trace Spans", "Error Traces"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Parameter", "value": "tool_choice", "options": ["tool_choice", "function_call", "run_option", "execution_mode"]}, {"label": "Value", "value": "required", "options": ["required", "auto", "none", "forced"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Tracing To address the reported issues with the Microsoft Foundry project's customer support agent, the chosen", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
    correctOptionIds: ["D"],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Parameter", "value": "tool_choice", "options": ["tool_choice", "function_call", "tool_mode", "execution_policy"]}, {"label": "Value", "value": "required", "options": ["required", "auto", "none", "strict"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Call Azure AI Search directly from each application by using Microsoft Entra authentication.", whyIncorrect: "" },
      { id: "B", text: "Configure an Azure AI Search connection in Project1 and reference the connection in each application", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Access up-to-date public information", "value": "Grounding with Bing Search", "options": ["Grounding with Bing Search", "Code interpreter", "File search", "Custom Web Search"]}, {"label": "Perform calculations", "value": "Code interpreter", "options": ["Grounding with Bing Search", "Code interpreter", "File search", "Math Engine"]}, {"label": "Retrieve uploaded documents", "value": "File search", "options": ["Grounding with Bing Search", "Code interpreter", "File search", "Document Store"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "the Azure Monitor Agent", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Create and reuse a conversation by storing the conversation’s ID and supplying the ID on subsequent", whyIncorrect: "" },
      { id: "B", text: "Persist only the final model response stored in the client application and prepend the response to future", whyIncorrect: "" },
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "temperature", "value": "1", "options": ["0", "0.5", "0.7", "1"]}, {"label": "output_config effort", "value": "low", "options": ["low", "medium", "high", "none"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Retain user preferences across chat sessions", "value": "Agent memory that uses persistent storage", "options": ["Agent memory that uses persistent storage", "File search tool", "Session context cache", "Browser local storage"]}, {"label": "Contextual grounding during chats", "value": "File search tool", "options": ["Agent memory that uses persistent storage", "File search tool", "Bing Grounding tool", "Code Interpreter tool"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Authentication method", "value": "Azure Login action that uses OpenID Connect (OIDC)", "options": ["Azure Login action that uses OpenID Connect (OIDC)", "Service Principal with client secret", "Personal Access Token (PAT)", "API Key in GitHub Secrets"]}, {"label": "Workflow action on failure", "value": "Fail", "options": ["Fail", "Continue", "Skip", "Warn"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      ...
      { id: "D", text: "Enable mask_inpainting and supply both the input image and a mask indicating which part of the image to", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
    correctOptionIds: ["D"],
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "prebuilt-layout The correct option for the given requirement is D", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
    correctOptionIds: ["D"],
  ...
  },
  {
    ...
    answerItems: [{"label": "Prompt Shields action", "value": "Set action to block", "options": ["Set action to block", "Set action to audit", "Set action to warn", "Set action to ignore"]}, {"label": "Additional mitigation", "value": "Enable Spotlighting", "options": ["Enable Spotlighting", "Enable PII Masking", "Enable Content Filter", "Enable Rate Limiting"]}],
    correctOptionIds: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Apply keyword scanning to optical character recognition (OCR) output by using Azure Vision in Foundry", whyIncorrect: "" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "a custom Azure Content Understanding in Foundry Tools analyzer that defines the required fields as the", whyIncorrect: "" },
      { id: "C", text: "the Azure Content Understanding in Foundry Tools prebuilt-layout analyzer", whyIncorrect: "" },
      { id: "D", text: "the Azure Content Understanding in Foundry Tools prebuilt-documentSearch analyzer and search.score from", whyIncorrect: "" },
    ],
    answer: "B",
    answerItems: [{"label": "Correct option", "value": "B"}],
    correctOptionIds: ["B"],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "indexer status and failure history", whyIncorrect: "" },
      { id: "B", text: "latency breakdown traces", whyIncorrect: "" },
      { id: "C", text: "groundedness evaluation metrics", whyIncorrect: "" },
      { id: "D", text: "Groundedness Evaluation Metrics is the most suitable choice, and why the others are less appropriate", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
    correctOptionIds: ["D"],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "risk and safety metrics", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
      { id: "E", text: "Option E (Visual Block)", whyIncorrect: "" },
    ],
    answer: "AE",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Remove stop sequences from the requests.", whyIncorrect: "" },
      { id: "B", text: "Decrease the temperature parameter.", whyIncorrect: "" },
      { id: "C", text: "Increase the temperature parameter.", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
    answerItems: [{"label": "Correct option", "value": "C"}],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "zero-shot learning", whyIncorrect: "" },
      { id: "B", text: "chain of thought", whyIncorrect: "" },
      { id: "C", text: "few-shot learning", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
  ...
  },
  {
    ...
    answerItems: [{"label": "session_id", "value": "user_id", "options": ["user_id", "session_context", "auto_id", "client_guid"]}, {"label": "storage_type", "value": "session", "options": ["session", "global", "ephemeral", "temporary"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Enable logging by using the client SDK for Content Safety.", whyIncorrect: "" },
      { id: "B", text: "Enable application tracing in Project1.", whyIncorrect: "" },
      { id: "C", text: "Route requests through the Azure OpenAI endpoint.", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
    answerItems: [{"label": "Correct option", "value": "C"}],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Workflow logic", "value": "Condition/decision branch for risk", "options": ["Condition/decision branch for risk", "Loop iterator node", "Parallel execution branch", "Exception handler node"]}, {"label": "Approval checkpoint", "value": "Ask for approval / Ask a question node", "options": ["Ask for approval / Ask a question node", "Auto-approve node", "Send email notification node", "Log event node"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Restart Agent from Foundry Control Plan", whyIncorrect: "" },
      { id: "B", text: "Enable Application Insights for Agent1.", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "D",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "vector search only", whyIncorrect: "" },
      { id: "B", text: "semantic search only", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "B",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Document Extraction", whyIncorrect: "" },
      { id: "B", text: "GenAI Prompt", whyIncorrect: "" },
      { id: "C", text: "Document Layout", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "B",
    answerItems: [{"label": "Correct option", "value": "B"}],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Text Translation", whyIncorrect: "" },
      { id: "B", text: "optical character recognition (OCR)", whyIncorrect: "" },
      { id: "C", text: "Image Analysis", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
    answerItems: [{"label": "Correct option", "value": "C"}],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "Field value type", "value": "string", "options": ["string", "object", "array", "boolean"]}, {"label": "Field method", "value": "generate", "options": ["generate", "extract", "lookup", "transform"]}, {"label": "Prompt", "value": "Describe the color scheme of the video segment", "options": ["Describe the color scheme of the video segment", "Extract text overlay from the video", "Identify keyframes in the video", "Detect faces in the video"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "a single-file task in standard mode that uses the vendor contract provided as an additional document during", whyIncorrect: "" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "Add the image URL to the request metadata section, so the model can resolve the processing issue", whyIncorrect: "" },
      { id: "D", text: "Place the image URL inside the System Message and set type to image_url so the model loads the image at", whyIncorrect: "" },
    ],
    answer: "A",
    answerItems: [{"label": "Correct option", "value": "A"}],
    correctOptionIds: ["A"],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "RTMP", whyIncorrect: "" },
      { id: "B", text: "WebRTC", whyIncorrect: "" },
      { id: "C", text: "SIP", whyIncorrect: "" },
      { id: "D", text: "WebSocket", whyIncorrect: "" },
    ],
    answer: "D",
    answerItems: [{"label": "Correct option", "value": "D"}],
    correctOptionIds: ["D"],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Set project-endpoint to the endpoint of the project.", whyIncorrect: "" },
      { id: "B", text: "Set evaluation-config to the path of the YAML file.", whyIncorrect: "" },
      { id: "C", text: "Set model-deployment-name to the deployed model.", whyIncorrect: "" },
      { id: "D", text: "Set tenant-id to the Microsoft Entra tenant ID", whyIncorrect: "" },
    ],
    answer: "A",
    answerItems: [{"label": "Correct option", "value": "A"}],
    correctOptionIds: ["A"],
  ...
  },
  {
    ...
    answer: "YesNoYes",
    answerItems: [{"label": "Can detect custom objects without model deployment", "value": "Yes", "options": ["Yes", "No"]}, {"label": "Can extract structured JSON from unstructured text", "value": "No", "options": ["Yes", "No"]}, {"label": "Can preserve document layout and table bounds", "value": "Yes", "options": ["Yes", "No"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Telemetry tracking signal 1", "value": "Trace context", "options": ["Trace context", "Custom dimensions", "Event log", "Metric payload"]}, {"label": "Telemetry tracking signal 2", "value": "Custom dimensions", "options": ["Trace context", "Custom dimensions", "Event log", "Metric payload"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "HTTP 429 Error Resolution", "value": "Implement exponential backoff retry logic", "options": ["Implement exponential backoff retry logic", "Validate file size against model limits before upload", "Increase VM vCPU quota", "Switch to key-based auth"]}, {"label": "HTTP 400 Error Resolution", "value": "Validate file size against model limits before upload", "options": ["Implement exponential backoff retry logic", "Validate file size against model limits before upload", "Increase VM vCPU quota", "Switch to key-based auth"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "self-hosted container", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Add a retry evaluation before the responses are returned.", whyIncorrect: "" },
      { id: "B", text: "Decrease the value of the temperature parameter.", whyIncorrect: "" },
      { id: "C", text: "Increase the value of the presence_penalty parameter", whyIncorrect: "" },
      { id: "D", text: "Replace the model with a smaller deployment.", whyIncorrect: "" },
    ],
    answer: "A",
    answerItems: [{"label": "Correct option", "value": "A"}],
  ...
  },
  {
    ...
    answer: "YesYesNo",
    answerItems: [{"label": "Vision API detects brand logos in images", "value": "Yes", "options": ["Yes", "No"]}, {"label": "Returns confidence scores for brand detection", "value": "Yes", "options": ["Yes", "No"]}, {"label": "Requires pre-training custom vision model", "value": "No", "options": ["Yes", "No"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "the Azure SDK for Python and PowerShell cmdlets.", whyIncorrect: "" },
      { id: "B", text: "the Azure portal and Microsoft Graph API", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Use Speech Synthesis Markup Language (SSML) to apply say as rules.", whyIncorrect: "" },
      { id: "B", text: "Use Speech Synthesis Markup Language (SSML) to adjust the prosody of the voice.", whyIncorrect: "" },
      { id: "C", text: "From Azure OpenAI use the Whisper model.", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "B",
    answerItems: [{"label": "Correct option", "value": "B"}],
  ...
  },
  {
    ...
    answer: "Yes, No, Yes",
    answerItems: [{"label": "Redacts PII before sending prompt to model", "value": "Yes", "options": ["Yes", "No"]}, {"label": "Stores unmasked PII in Application Insights", "value": "No", "options": ["Yes", "No"]}, {"label": "Preserves original sentence context for model", "value": "Yes", "options": ["Yes", "No"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    answerItems: [{"label": "Step 1", "value": "Create a project", "options": ["Create a project", "Upload and tag images", "Train and publish the model", "Configure API endpoint"]}, {"label": "Step 2", "value": "Upload and tag images", "options": ["Create a project", "Upload and tag images", "Train and publish the model", "Configure API endpoint"]}, {"label": "Step 3", "value": "Train and publish the model", "options": ["Create a project", "Upload and tag images", "Train and publish the model", "Configure API endpoint"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "reliability and safety", whyIncorrect: "" },
      { id: "B", text: "Option B (Visual Block)", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Azure Document Intelligence in Foundry Tools", whyIncorrect: "" },
      { id: "B", text: "Azure AI Immersive Reader", whyIncorrect: "" },
      { id: "C", text: "Option C (Visual Block)", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "C",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "the endpoint URI and subscription key", whyIncorrect: "" },
      { id: "B", text: "the endpoint URI and an OAuth token", whyIncorrect: "" },
      { id: "C", text: "the endpoint URI and a shared access signature (SAS) token", whyIncorrect: "" },
      { id: "D", text: "Option D (Visual Block)", whyIncorrect: "" },
    ],
    answer: "A",
    answerItems: [{"label": "Correct option", "value": "A"}],
  ...
  },
  {
    ...
    prompt: "Client applications must display page-level citations that have bounding polygons for both text and images. Provide text and image location metadata. \nExtract tables that span multiple pages.",
    options: [
      { id: "A", text: "Document", whyIncorrect: "" },
      { id: "B", text: "Document", whyIncorrect: "" },
      { id: "C", text: "Azure Content Understanding", whyIncorrect: "" },
      { id: "D", text: "GenAI Prompt", whyIncorrect: "" },
    ],
    answer: "C",
    answerItems: [{"label": "Correct option", "value": "C"}],
    correctOptionIds: ["C"],
  ...
  },
  {
    ...
    answer: "",
    answerItems: [{"label": "JSON data projection type", "value": "Object projection", "options": ["Object projection", "Table projection", "File projection", "Vector projection"]}, {"label": "Extracted text data projection type", "value": "Table projection", "options": ["Object projection", "Table projection", "File projection", "Vector projection"]}],
    correctOptionIds: [],
    explanation: "",
    reasoning: [],
    keywords: [],
