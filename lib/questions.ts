...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Azure AI Search",
      "Microsoft Foundry",
      "recommend a solution to centrally manage the"
    ],
    "sourcePages": [
      7,
      8
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "LangChain service will appear in Traces without",
      "Setting different OTEL_SERVICE_NAME values separates the services",
      "When using enable_content_recording=False, prompts and tool data",
      "Microsoft Foundry",
  ...
  },
  {
    ...
    "options": [],
    "answer": "credential = DefaultAzureCredential(); response = openai_client.responses.create(...)",
    "answerItems": [
      {
    ...
    "keywords": [
      "DefaultAzureCredential",
      "First Dropdown (credential =)",
      "create",
      "Second Dropdown (response = openai_client.responses.)",
      "Azure OpenAI",
      "managed identity",
      "OpenAI"
    ],
  ...
  },
  {
    ...
    "options": [],
    "answer": "If/else condition: Not(IsBlank(Local.Var01)). Send message: {Upper(Local.Var01)}.",
    "answerItems": [
      {
  ...
  },
  {
    ...
    "options": [],
    "answer": "Guardrails: Select User input, Output, Tool response, and Tool call; Action = Block. Storage access: System-assigned managed identity with Storage Blob Data Reader role.",
    "answerItems": [
      {
      ...
      },
      {
        ...
        "value": "System-assigned managed identity with Storage Blob Data Reader role",
        "options": [
    ...
    "reasoning": [],
    "keywords": [
      "Select User input, Output, Tool response, and Tool call",
  ...
  },
  {
    ...
    "keywords": [
      "workflow",
      "Microsoft Foundry",
      "orchestrate the agents to ensure that the"
    ],
    "sourcePages": [
      15
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "Speech",
      "set the project property to the correct ID"
    ],
    "sourcePages": [
      16
    ],
  ...
  },
  {
    ...
    "options": [],
    "answer": "Approval step type: ask_question. Condition: approval == \"approved\".",
    "answerItems": [
      {
    ...
    "keywords": [
      ...
      "workflow",
      "human approval",
      "ensure that the workflow pauses for human"
    ],
    "sourcePages": [
      17,
      18
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Speech recognition requests will fall back to",
      "Speech",
      "base model"
    ],
    "sourcePages": [
  ...
  },
  {
    ...
    "keywords": [
      ...
      "OpenAI",
      "model deployment",
      "ensure that the developers can perform model inference"
    ],
    "sourcePages": [
      20
    ],
  ...
  },
  {
    ...
    "explanation": "A. tool_choice=\"required\". The tool_choice parameter controls whether the model may answer directly or must invoke a tool. Setting it to required forces tool execution before the final response.",
    "reasoning": [],
    "keywords": [
      ...
      "tool_choice",
      "base model",
      "add the correct tool _choice parameter to"
    ],
    "sourcePages": [
      21
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "OpenAPI",
      "ensure that the key value from the"
    ],
    "sourcePages": [
      22,
      23
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Use a model cascade that routes the",
      "Microsoft Foundry",
      "model cascade",
      "reduce costs and latency for common queries,"
    ],
    "sourcePages": [
      23,
      24
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Provisioned Utilization",
      "identify whether each issue is caused by"
    ],
    "sourcePages": [
      24,
      25,
  ...
  },
  {
    ...
    "options": [],
    "answer": "Set tool_choice to required. Configure tool authentication by using a distinct agent identity bound to the client application.",
    "answerItems": [
      {
      ...
      {
        "label": "Configure tool authentication by",
        "value": "Using a distinct agent identity bound to the client application",
        "options": [
    ...
    "keywords": [
      "required",
      "Set tool_choice to",
      "Using a distinct agent identity bound to",
      "Configure tool authentication by",
      "Microsoft Foundry",
      "tracing",
      "tool_choice",
      "workflow"
  ...
  },
  {
    ...
    "keywords": [
      ...
      "OpenAPI",
      "Connection1",
      "ensure that the OpenAPI tool automatically includes"
    ],
    "sourcePages": [
      28,
      29
  ...
  },
  {
    ...
    "keywords": [
      "Tracing",
      "Microsoft Foundry",
      "inspect individual agent runs to view the"
    ],
    "sourcePages": [
      29,
      30
  ...
  },
  {
    ...
    "explanation": "A. Yes. A prompt shield for documents helps detect and block hidden malicious instructions in uploaded content before the extracted content is used by the model.",
    "reasoning": [],
    "keywords": [
      "implement controls to mitigate the risk"
    ],
  ...
  },
  {
    ...
    "explanation": "A. a Retrieval Augmented Generation (RAG) evaluator. A RAG evaluator assesses responses that use retrieved product information from storage1 for relevance, completeness, and accuracy.",
    "reasoning": [],
    "keywords": [
      "Retrieval Augmented Generation (RAG) evaluator",
      "Microsoft Foundry",
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Configure an Azure AI Search connection in",
      "Azure AI Search",
      "integrate Project1 and App1"
    ],
    "sourcePages": [
      42,
      43
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Access up-to-date public information",
      "Code interpreter",
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "tracing",
      "implement end-to-end tracing to capture latency breakdowns"
    ],
    "sourcePages": [
      44,
      45
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Create and reuse a conversation by storing",
      "Microsoft Foundry",
      "Foundry Agent Service",
      "ensure that the agent automatically reloads the"
    ],
    "sourcePages": [
      45,
      46
  ...
  },
  {
    ...
    "keywords": [
      ...
      "output_config effort",
      "Microsoft Foundry",
      "update the request parameters to improve output stability"
    ],
    "sourcePages": [
      47,
      48
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "Retrieval Augmented Generation",
      "connect to the index to meet the following requirements:"
    ],
    "sourcePages": [
      48,
      49
  ...
  },
  {
    ...
    "keywords": [
      "Agent memory that uses persistent storage",
      "Retain user preferences across chat sessions",
      "File search tool",
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Implement a retry policy that uses exponential",
      "Microsoft Foundry",
      "Foundry Agent Service",
      "OpenAI",
      "model deployment",
      "handle throttling to reduce call failures and"
    ],
    "sourcePages": [
      51,
      52
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Enable mask_inpainting and supply both the input",
      "Microsoft Foundry",
      "workflow",
      "ensure that image edits apply exclusively inside"
    ],
    "sourcePages": [
      58,
      59
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Apply a mask-based inpainting edit to the",
      "Microsoft Foundry",
      "remove only the logo, while preserving the"
    ],
    "sourcePages": [
      59,
      60
  ...
  },
  {
    ...
    "keywords": [
      ...
      "extract content and layout elements and detect"
    ],
    "sourcePages": [
      60,
      61
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "model deployment",
      "ensure that the generated images maintain the"
    ],
    "sourcePages": [
      62
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Prompt Shields",
      "Spotlighting",
      "prevent a prompt injection attack and ensure"
    ],
    "sourcePages": [
      63
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "image moderation",
      "automatically classify uploaded images for harmful content"
    ],
    "sourcePages": [
      63,
      64
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Prompt Shields",
      "model deployment",
      "prevent potentially malicious instructions from being processed"
    ],
    "sourcePages": [
      64,
      65
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Azure Content Understanding in Foundry Tools analyzer",
      "Microsoft Foundry",
      "Content Understanding",
      "process mixed-format documents that contain scanned text,"
    ],
    "sourcePages": [
      66,
      67
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Content Understanding",
      "implement a solution that provides OCR, layout"
    ],
    "sourcePages": [
      67,
      68
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "Retrieval Augmented Generation",
      "configure an ingestion job for a Retrieval"
    ],
    "sourcePages": [
      68,
      69
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "indexer to extract image data into a",
      "Azure AI Search",
      "Microsoft Foundry",
      "ensure that during indexing, the images are"
    ],
    "sourcePages": [
      69,
      70
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "skillset to run the OCR skill directly"
    ],
    "sourcePages": [
      70,
      71,
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Retrieval Augmented Generation",
      "Content Understanding",
      "ensure that the Content Understanding document analyzer"
    ],
    "sourcePages": [
      73,
      74
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Use real-time speech to text to process",
      "Microsoft Foundry",
      "Speech",
      "ensure that the call transcripts appear within"
    ],
    "sourcePages": [
      74,
      75
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Use real-time speech to text for incoming",
      "Microsoft Foundry",
      "workflow",
      "Speech",
      "enable both speech to text and text"
    ],
    "sourcePages": [
      75,
      76,
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Split the mixed-language segments into single-language segments",
      "Speech",
      "Translator",
  ...
  },
  {
    ...
    "keywords": [
      ...
      "configure Azure Document Intelligence in Foundry Tools"
    ],
    "sourcePages": [
      84,
      85
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "custom Azure Content Understanding in Foundry Tools",
      "Microsoft Foundry",
      "Content Understanding",
      "create a single analyzer that meets the"
    ],
    "sourcePages": [
      85,
      86
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "groundedness",
      "identify whether the retrieved content is negatively"
    ],
    "sourcePages": [
      86,
      87
  ...
  },
  {
    ...
    "options": [],
    "answer": "Create video: create. Poll video status: retrieve.",
    "answerItems": [
      {
        "label": "Create video",
        "value": "create",
  ...
  },
  {
    ...
    "options": [],
    "answer": "credential: DefaultAzureCredential(). agent method: get.",
    "answerItems": [
      {
        "label": "credential",
        "value": "DefaultAzureCredential()",
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "Retrieval Augmented Generation",
      "ensure that Pipeline1 fails if unsupported content"
    ],
    "sourcePages": [
      95
    ],
  ...
  },
  {
    ...
    "keywords": [
      "conversation",
      "Microsoft Foundry",
      "persist state by using a durable ID"
    ],
    "sourcePages": [
      95
    ],
  ...
  },
  {
    ...
    "options": [],
    "answer": "Supported and addresses query: Groundedness and Relevance. Sensitive or proprietary information: Protected material.",
    "answerItems": [
      {
        "label": "Supported by context and addresses query",
      ...
      {
        "label": "Sensitive or proprietary information",
    ...
    "keywords": [
      "Groundedness and Relevance",
      "Supported by context and addresses query",
      "Protected material",
      "Sensitive or proprietary information",
      "Microsoft Foundry",
      "groundedness",
      "Retrieval Augmented Generation",
      "run a pre-production evaluation by using labeled"
    ],
    "sourcePages": [
      95,
      96
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "D",
        "text": "Al quality (NLP) metrics"
      },
      {
        "id": "E",
        "text": "Al quality (Al assisted) metrics"
      }
    ],
    "answer": "AE",
    "answerItems": [
    ...
    "keywords": [
      "A, E",
      "risk and safety metrics",
      "Al quality (Al assisted) metrics",
      "Microsoft Foundry",
      "groundedness",
      "Retrieval Augmented Generation",
      "provide scores for groundedness, relevance, and harmful"
    ],
    "sourcePages": [
      96
    ],
  ...
  },
  {
    ...
    "keywords": [
      "Azure AI Search",
      "Microsoft Foundry",
      "ensure that for a specific run, the"
    ],
    "sourcePages": [
      96,
      97
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "reduce response variability, without modifying the prompt"
    ],
    "sourcePages": [
      97
    ],
  ...
  },
  {
    ...
    "keywords": [
      "few-shot learning",
      "Microsoft Foundry",
      "improve accuracy by showing the model how"
    ],
    "sourcePages": [
      97
    ],
  ...
  },
  {
    ...
    "options": [],
    "answer": "scope: \"{{$userId}}\". tools: [memory_tool].",
    "answerItems": [
      {
        "label": "scope",
        "value": "\"{{$userId}}\"",
    ...
    "keywords": [
      ...
      "tools",
      "Microsoft Foundry",
      "enable long-term memory to ensure that the"
    ],
    "sourcePages": [
      97,
      98
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "D",
        "text": "Route requests through the Azure OpenAl endpoint."
      }
    ],
    "answer": "C",
    "answerItems": [
    ...
    "reasoning": [],
    "keywords": [
      "Enable application tracing in Project1",
      "Microsoft Foundry",
      "tracing",
      "workflow",
      "configure end-to-end visibility into each step of"
    ],
    "sourcePages": [
      98
    ],
  ...
  },
  {
    ...
    "answerItems": [
      {
        ...
        "value": "The sequential template that passes outputs node by-node",
        "options": [
          "The sequential template that passes outputs node by-node",
          "The group chat template to dynamically route control between the agents",
          "The human-in-the-loop template that pauses execution of the workflow for input"
      ...
      },
      {
        ...
        "value": "Add an Ask a question node",
        "options": [
          "Add a Basic chat node",
          "Add a Condition statement",
          "Add an Ask a question node"
    ...
    "reasoning": [],
    "keywords": [
      "sequential template that passes outputs node by-node",
      "Orchestration pattern",
      "Add an Ask a question node",
      "Approval checkpoints",
      "Microsoft Foundry",
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Application Insights",
      "token usage",
      "ensure that Found Control Plane displays the"
    ],
    "sourcePages": [
      99
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "workflow",
      "Content Understanding",
      "generate a Markdown output that has a"
    ],
    "sourcePages": [
      99,
      100
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Microsoft Foundry",
      "Retrieval Augmented Generation",
      "build a solution that supports semantic similarity"
    ],
    "sourcePages": [
      100
    ],
  ...
  },
  {
    ...
    "keywords": [
      "hybrid search",
      "Microsoft Foundry",
      "ensure that users can query the index"
    ],
    "sourcePages": [
      100
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Azure AI Search",
      "Content Understanding",
      "add a single built-in multimodal content extraction"
    ],
    "sourcePages": [
      100,
      101
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Azure AI Search",
      "enable users to search invoice data across"
    ],
    "sourcePages": [
      101
    ],
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "multiple-file task in pro mode that uses",
      "Content Understanding",
      "configure Pipeline1 and expose the pipeline as"
    ],
    "sourcePages": [
      102
    ],
  ...
  },
  {
    ...
    "keywords": [
      "Apply a mask-based inpainting edit to the",
      "Microsoft Foundry",
      "remove the watermark without regenerating the videos"
    ],
    "sourcePages": [
      102,
      103
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Set the user message content array to",
      "model deployment",
      "send the message as a structured array"
    ],
    "sourcePages": [
      103
    ],
  ...
  },
  {
    ...
    "keywords": [
      "WebSocket",
      "Microsoft Foundry",
      "configure a connection method that supports real-time"
    ],
    "sourcePages": [
      103
    ],
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Set evaluation-config to the path of the YAML file",
      "Microsoft Foundry",
      "workflow",
  ...
  },
  {
    ...
    "answerItems": [
      {
        ...
        "value": "Enable a system-assigned managed identity at the project level",
        "options": [
          "Enable a system-assigned managed identity at the Foundry level",
          "Enable a system-assigned managed identity at the project level",
          "Create a service principal and store the principal's client secret"
    ...
    "reasoning": [],
    "keywords": [
      "Enable a system-assigned managed identity at the",
      "Managed identity scope",
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Can detect custom objects without model deployment",
      "Can extract structured JSON from unstructured text",
      "Can preserve document layout and table bounds",
      "Microsoft Foundry",
      "protected material",
      "Document Layout",
      "model deployment"
  ...
  },
  {
    ...
    "keywords": [
      "Hierarchical spans",
      "Capture all the nested operations across the",
      "Tool call attributes",
      "Record tool invocation arguments and returned results",
      "Microsoft Foundry",
      "implement responsible AI auditing to meet the"
    ],
    "sourcePages": [
      105
    ],
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Implement exponential backoff and jitter in the",
      "HTTP 429 Error Resolution",
      "Split content into smaller files before uploading",
  ...
  },
  {
    ...
    "keywords": [
      ...
      "agent memory",
      "persistent storage",
      "create a customer support agent that meets"
    ],
    "sourcePages": [
      108,
      109
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Vision API detects brand logos in images",
      "Returns confidence scores for brand detection",
      "Requires pre-training custom vision model",
      "Custom Vision"
    ],
    "sourcePages": [
      109,
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Microsoft Foundry and the Azure Command Line",
      "Microsoft Foundry",
      "DALL-E",
      "deploy the model"
    ],
  ...
  },
  {
    ...
    "options": [],
    "answer": "kind: OpenAI. API property option: --encryption.",
    "answerItems": [
      {
        "label": "kind",
        "value": "OpenAI",
    ...
    "keywords": [
      ...
      "create a new resource that will generate"
    ],
    "sourcePages": [
      110,
      111
  ...
  },
  {
    ...
    "answerItems": [
      {
        "label": "request",
        "value": "AnalyzeTextOptions(text=comment)",
        "options": [
          "AnalyzeTextOptions(categories=comment)",
          "AnalyzeTextOptions(text=[comment])",
          "AnalyzeTextOptions(text=comment)",
      ...
      {
        "label": "response",
        "value": "client.analyze_text(request)",
        "options": [
          "client.analyze_image(request)",
          "client.analyze_text(request)",
          "client.moderate_text(request)",
    ...
    "keywords": [
      ...
      "AnalyzeTextOptions",
      "analyze_text",
      "send a text comment to Azure AI"
    ],
    "sourcePages": [
      111,
      112
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Replace ContactInfo by using Phone, Email, and",
      "improve the precision of the project"
    ],
    "sourcePages": [
      112
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "E",
        "text": "From Azure OpenAl use the Whisper model."
      }
    ],
    "answer": "B",
    "answerItems": [
    ...
    "reasoning": [],
    "keywords": [
      "Use Speech Synthesis Markup Language (SSML) to",
      "Speech",
      "SSML",
      "phonemes",
      "prevent the incorrect pronunciations"
    ],
    "sourcePages": [
      113
    ],
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "Redacts PII before sending prompt to model",
      "Stores unmasked PII in Application Insights",
      "Preserves original sentence context for model",
      "Application Insights",
      "PII"
    ],
    "sourcePages": [
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Custom Vision",
      "use the Azure Custom Vision API to"
    ],
    "sourcePages": [
      115
    ],
  ...
  },
  {
    ...
    "keywords": [
      ...
      "Immersive Reader",
      "ensure that the reading experience is optimized"
    ],
    "sourcePages": [
      116
    ],
  ...
  },
  {
    ...
    "reasoning": [],
    "keywords": [
      "endpoint URI and subscription key",
      "Microsoft Foundry",
      "configure App1 to access CSAccount1"
    ],
    "sourcePages": [
      116
    ],
  ...
  },
  {
    ...
    "answerItems": [
      ...
      {
        "label": "Step 2",
        "value": "Change the app to use the new key",
        "options": [
          "Regenerate the primary admin key",
          "Regenerate the secondary admin key",
          "Change the app to use the secondary admin key",
      ...
      {
        "label": "Step 3",
        "value": "Delete the compromised key",
        "options": [
          "Regenerate the primary admin key",
          "Regenerate the secondary admin key",
          "Change the app to use the secondary admin key",
    ...
    "keywords": [
      ...
      "Azure AI Search",
      "query key",
      "prevent unauthorized access to the search endpoint"
    ],
    "sourcePages": [
      116,
      117
  ...
  },
  {
    ...
    "options": [],
    "answer": "HTTP method: PUT. kind: CognitiveServices.",
    "answerItems": [
      {
        "label": "HTTP method",
        "value": "PUT",
    ...
    "keywords": [
      ...
      "CognitiveServices",
      "kind",
      "create a new resource that will be"
    ],
    "sourcePages": [
      117,
      118
  ...
  },
  {
    ...
    "options": [],
    "answer": "False positives percentage: 0. Recall value: 25.",
    "answerItems": [
      {
        "label": "The percentage of false positives",
        "value": "0",
        "options": [
          "0",
          "25",
      ...
      {
        "label": "True positives divided by true positives plus false negatives",
        "value": "25",
        "options": [
          "0",
          "25",
    ...
    "keywords": [
      ...
      "True positives divided by true positives plus"
    ],
    "sourcePages": [
      118,
      119
  ...
  },
  {
    ...
    "keywords": [
      "Object projection",
      "JSON data projection type",
      "Table projection",
      "Extracted text data projection type",
      "Azure AI Search"
    ],
    "sourcePages": [
      120,
